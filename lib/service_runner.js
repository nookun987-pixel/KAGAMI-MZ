...
const SERVICE_CONFIG = {
  fooocus: {
    ...
    port: 7865,
    healthPath: '/',
    startCmd: ['python', ['scripts/fooocus_bridge.py'], { cwd: ROOT, detached: true, stdio: 'ignore', windowsHide: true }],
  ...
  ollama: {
    ...
    port: 11434,
    healthPath: '/api/tags',
    startCmd: ['ollama', ['serve'], { cwd: ROOT, detached: true, stdio: 'ignore', windowsHide: true }],
