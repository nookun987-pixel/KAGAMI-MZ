...
- Thirty-third controlled exception is open:
  ...
  - ALLOWED (only the two-slit emission STRENGTH curve, hue locked): DORMANT ≈ near-off, ~10–15% of awakened; MID ~35–45%; AWAKENED = current peak (unchanged); ignition (dormant→awakened) happens fast around 60–75% of the clip (~3.6–4.5s), not spread evenly; keep a smooth loop (first frame ≈ last — mostly dormant, an ignition spike ~65%, brief awakened, quick decay back to dormant); breathing zoom stays as-is.
  ...
  - VERIFY (mandatory): reopen clean; BODY_HASH + transform unchanged vs V0.1; material hue unchanged (only slit-strength keyframe differs); ffprobe 1080x1920/30fps/yuv420p/no-audio/~6.03s; report the emission level of each state as a % of peak (dormant 10–15%, mid 35–45%, awakened 100%); pixel-sample the awakened slit (violet near #8F00FF, not magenta); keyframe strip dormant/mid/awakened.
