# -*- coding: utf-8 -*-
r"""
MIKAGE BUILD LOG — STANDING HERO V0_3 (operator corrections 2026-07-02 x2):
(1) FULL 0 -> final arc, and (2) the contact sheets are MULTI-PANEL review boards — do NOT
paste them whole ("đè 1 ảnh chèn nhạc"). Every image beat = ROSTRUM CAMERA: the sheet is
scaled near frame height and the camera PANS across the panels (their printed labels stay
readable), while the REAL per-round notes (what the pass did / what got FLAGGED or RULED)
run on a scrim at the bottom. Notes are transcribed from the dispatch/ruling records in
docs/handoff + reviews — no invented status.

Supersedes v0_1/v0_2 scripts (kept for history — do not run).
...
Run on the operator's machine:  python build_buildlog_standing_hero_v0_3.py
...
OUT   = os.path.join(HERE, "MIKAGE_BUILDLOG_STANDING_HERO_V0_3.mp4")
OUT_HOOK = os.path.join(HERE, "MIKAGE_BUILDLOG_STANDING_HERO_V0_3_HOOK.mp4")
