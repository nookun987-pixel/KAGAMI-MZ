...
- ACTIVE_PHASE: GOVERNANCE / OPERATOR_REST_MODE_V0 with public render page push completed
...
- MIKAGE_CHARACTER_FINAL_BUILD_INPUT_LOCK_GATE_V0_1_PHASE: OPEN_BLOCKED_SCOPE_RISK
- FINAL_COMPLETION_PREP_GATE: OPEN
- INPUT_LOCK_GATE: OPEN_BLOCKED_SCOPE_RISK
- CURRENT_NEXT_TASK: MIKAGE_CHARACTER_FINAL_BUILD_DERIVATIVE_V0_1
- CHARACTER_FINAL_COMPLETE: NOT_CLAIMED
- CANONICAL_FINAL_BLEND_STATUS: MISSING
- FINAL_BUILD_ALLOWED: NO
- INPUT_LOCK_DECISION: INPUT_LOCK_BLOCKED_SCOPE_RISK
...
- PREVIOUS_PUBLIC_RENDER_PAGE_NEXT_TASK = MIKAGE_PUBLIC_RENDER_PAGE_UPDATE_V0_1.
- PAGE_UPDATE_GATE = OPEN.
- PRODUCTION_RIG_READY = YES.
- RENDER_ALLOWED = YES.
- DEFORMATION_TEST_ALLOWED = NO.
