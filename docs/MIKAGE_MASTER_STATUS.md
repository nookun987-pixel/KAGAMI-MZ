...
- ACTIVE_PHASE: GOVERNANCE / OPERATOR_REST_MODE_V0 with public render readiness gate opened
...
- CURRENT_NEXT_TASK: OWNER_DEFINE_PUBLIC_RENDER_READINESS_PREP_OR_REVIEW
...
- Owner may define a bounded public-render-readiness preparation or review task.
- PRODUCTION_RIG_READY = YES.
- RENDER_ALLOWED = NO.
- DEFORMATION_TEST_ALLOWED = NO.
- Public render ready and asset lock remain NO.
- Do not run or touch Lane B, website / HTML, public character pages, roster / queue, Z-Blue archive/history cleanup, sync, Telegram, GSheet, or push.
