...
- ACTIVE_PHASE: GOVERNANCE / OPERATOR_REST_MODE_V0 with owner-approved production rig ready status
...
- CURRENT_NEXT_TASK: OWNER_DEFINE_NEXT_POST_RIG_READY_GATE
...
- Owner may define the next post-rig-ready gate.
- PRODUCTION_RIG_READY = YES.
- RENDER_ALLOWED = NO.
- DEFORMATION_TEST_ALLOWED = NO.
