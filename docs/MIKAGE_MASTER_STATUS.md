...
- ACTIVE_PHASE: GOVERNANCE / OPERATOR_REST_MODE_V0 with public render candidate fix created for review
...
- CURRENT_NEXT_TASK: OPEN_READ_ONLY_PUBLIC_RENDER_CANDIDATE_FIX_REVIEW_TASK
...
- Open a read-only fix review task for `MIKAGE_PUBLIC_RENDER_CANDIDATE_FIX_V0_1`.
- PRODUCTION_RIG_READY = YES.
- RENDER_ALLOWED = YES.
- DEFORMATION_TEST_ALLOWED = NO.
- PUBLIC_RENDER_CANDIDATE_FIX_DECISION = PUBLIC_RENDER_CANDIDATE_FIX_CREATED_FOR_REVIEW.
