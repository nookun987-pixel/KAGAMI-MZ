...
- ACTIVE_PHASE: GOVERNANCE / OPERATOR_REST_MODE_V0 with public render preparation review completed
...
- CURRENT_NEXT_TASK: OWNER_OPEN_BOUNDED_RENDER_PERMISSION_GATE
...
- Owner may open a bounded render permission gate.
- PRODUCTION_RIG_READY = YES.
- RENDER_ALLOWED = NO.
- DEFORMATION_TEST_ALLOWED = NO.
