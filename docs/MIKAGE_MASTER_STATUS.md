...
- ACTIVE_PHASE: GOVERNANCE / OPERATOR_REST_MODE_V0 with public render candidate review completed
...
- CURRENT_NEXT_TASK: OPEN_BOUNDED_RENDER_CANDIDATE_FIX_TASK
...
- Open a bounded render candidate fix task for `MIKAGE_PUBLIC_RENDER_CANDIDATE_V0_1`.
- PRODUCTION_RIG_READY = YES.
- RENDER_ALLOWED = YES.
- DEFORMATION_TEST_ALLOWED = NO.
- PUBLIC_RENDER_CANDIDATE_REVIEW_DECISION = HOLD_FOR_PUBLIC_RENDER_CANDIDATE_FIX.
