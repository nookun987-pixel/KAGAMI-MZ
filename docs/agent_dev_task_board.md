...
## 2. Current Phase
- PHASE = Operator Rest Mode / Governance Handoff with controlled deformation smoke test gate open
- STATUS = MIKAGE_DEFORMATION_SMOKE_TEST_V0_1_PHASE_OPEN
...
- MIKAGE_DEFORMATION_SMOKE_TEST_V0_1_PHASE = OPEN
- DEFORMATION_SMOKE_TEST_GATE_OPEN = YES
...
- RENDER_ALLOWED = NO
- DEFORMATION_TEST_ALLOWED = YES only inside MIKAGE_DEFORMATION_SMOKE_TEST_V0_1
...
## 5. Next Safe Action
- Run exactly `MIKAGE_DEFORMATION_SMOKE_TEST_V0_1`.
- `RENDER_ALLOWED = NO`.
- `DEFORMATION_TEST_ALLOWED = YES` only inside this gated task.
