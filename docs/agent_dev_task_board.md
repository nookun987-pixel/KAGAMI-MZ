...
- LANE_A_RIG_REPAIR_EXECUTION_SOURCE_BLEND = production/character/production_actor/rig_derivatives/MIKAGE_PRODUCTION_ACTOR_FIRST_MOTION_TEST_FROM_APPROVED_GATE_V0_1.blend
- LANE_A_RIG_REPAIR_EXECUTION_OUTPUT_BLEND = production/character/production_actor/rig_derivatives/MIKAGE_PRODUCTION_ACTOR_RIG_REPAIR_PASS_V0_1_FROM_FIRST_MOTION_TEST_V0_1.blend
- LANE_A_RIG_REPAIR_EXECUTION_REQUIRED_PROOF_REPORT = docs/reports/LANE_A_RIG_REPAIR_EXECUTION_RESULT_V0_1.md
- LANE_A_RIG_REPAIR_EXECUTION_LIMITS = Inspect/repair only the 29 intended deforming meshes listed in LANE_A_RIG_REPAIR_PLAN_V1.md; keep hand_right_sword_hold_marker unbound; keep reference_anchor_v1_plane_hidden_from_render unbound; save only the approved derivative output blend; run metadata inspection and non-render in-memory pose check only; do not render; do not push; do not claim production rig ready.
- LANE_A_RIG_REPAIR_EXECUTION_NEXT_SAFE_ACTION = execute LANE_A_RIG_REPAIR_EXECUTION_V0_1
- LANE_A_RIG_REPAIR_EXECUTION_PRODUCTION_RIG_READY = NOT_CLAIMED
