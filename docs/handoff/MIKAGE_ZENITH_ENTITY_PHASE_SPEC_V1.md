...
- Shell: Boron Carbide (B4C) ceramic, matte white **#FAFAFA**, sterility index 100%.
- Pattern: deep/dark red (Đỏ trầm), absolutely symmetric.
...
- Thermodynamic overload per **Landauer's law (E ≥ k_B·T·ln2)**.
- Ceramic surface shows **heat-scorch scars (Erythema ab igne)**; pattern glows like blood vessels (rực mạch máu).
