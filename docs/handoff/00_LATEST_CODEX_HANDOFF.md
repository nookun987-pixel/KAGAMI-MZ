...
LATEST_COMPLETED_TASK = REVIEW_LIMITED_INTERNAL_FOLLOW_UP_GATE_SPLIT_FROM_LIMITATION_TRACKING_REVIEW_V0_1
...
## NEXT SAFE TASK
NEXT_SAFE_TASK = PREPARE_LEFT_HAND_PLACEHOLDER_FOLLOW_UP_GATE_FROM_LIMITED_SPLIT_V0_1

## NEXT TASK RULES
The next task must prepare the left-hand placeholder follow-up gate from the approved limited split before reopening any character asset production work.
