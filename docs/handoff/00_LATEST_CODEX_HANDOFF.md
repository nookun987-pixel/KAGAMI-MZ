...
LATEST_COMPLETED_TASK = PREPARE_LIMITED_DOWNSTREAM_INTERNAL_ASSET_DECISION_WORK_FROM_LIMITED_GATE_V0_1
...
## NEXT SAFE TASK
NEXT_SAFE_TASK = REVIEW_LIMITED_DOWNSTREAM_INTERNAL_ASSET_DECISION_WORK_FROM_LIMITED_GATE_V0_1

## NEXT TASK RULES
The next task may review the limited downstream internal asset decision work from the reviewed limited gate.
