...
LATEST_COMPLETED_TASK = PREPARE_LIMITED_INTERNAL_FOLLOW_UP_GATE_SPLIT_FROM_LIMITATION_TRACKING_REVIEW_V0_1
...
## NEXT SAFE TASK
NEXT_SAFE_TASK = REVIEW_LIMITED_INTERNAL_FOLLOW_UP_GATE_SPLIT_FROM_LIMITATION_TRACKING_REVIEW_V0_1

## NEXT TASK RULES
The next task must review the limited internal follow-up gate split before reopening any character asset production work.
