...
## NEXT SAFE TASK
NEXT_SAFE_TASK = REVIEW_FIRST_DIAGNOSTIC_CINEMATIC_PROOF_SHOT_FROM_APPROVED_GATE_V0_1

## NEXT TASK RULES
The next task must review the first diagnostic cinematic proof shot from the approved gate.
