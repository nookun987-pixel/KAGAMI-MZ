...
## NEXT SAFE TASK
NEXT_SAFE_TASK = REVIEW_DEFORMATION_SMOKE_TEST_FAILURE_FROM_FIRST_WEIGHT_BIND_PASS_V0_1

## NEXT TASK RULES
The next task must review the first deformation smoke test failure report.
