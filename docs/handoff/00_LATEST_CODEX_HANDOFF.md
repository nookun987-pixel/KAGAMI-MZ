...
LATEST_COMPLETED_TASK = PREPARE_INTERNAL_DIAGNOSTIC_STILL_RENDER_GATE_FROM_PLANNING_PACKAGE_V0_1
...
## NEXT TASK RULES
The next task may review the prepared internal diagnostic still render gate from the planning package.
