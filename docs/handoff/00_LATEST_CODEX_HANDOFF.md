...
LATEST_COMPLETED_TASK = REVIEW_FIRST_MOTION_TEST_FROM_APPROVED_MOTION_GATE_V0_1
...
## NEXT SAFE TASK
NEXT_SAFE_TASK = PREPARE_CINEMATIC_GATE_FROM_FIRST_MOTION_TEST_V0_1

## NEXT TASK RULES
The next task may prepare a cinematic gate from the first motion test review.
