...
## NEXT SAFE TASK
NEXT_SAFE_TASK = REVIEW_DEFORMATION_SMOKE_TEST_RERUN_AFTER_TARGETED_LEFT_HAND_BIND_REPAIR_V0_1

## NEXT TASK RULES
The next task must review the deformation smoke test rerun after the targeted left hand bind repair.
