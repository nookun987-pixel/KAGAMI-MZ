...
## NEXT SAFE TASK
NEXT_SAFE_TASK = PREPARE_CHARACTER_ASSET_PRODUCTION_PLAN_FROM_LIMITED_FINAL_RIG_V0_1

## NEXT TASK RULES
The next task may prepare a character asset production plan from the limited final rig declaration.
