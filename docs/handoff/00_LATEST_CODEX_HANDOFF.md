...
LATEST_COMPLETED_TASK = REVIEW_MOTION_GATE_FROM_DEFORMATION_SMOKE_TEST_RERUN_V0_1
...
## NEXT SAFE TASK
NEXT_SAFE_TASK = CREATE_FIRST_MOTION_TEST_FROM_APPROVED_MOTION_GATE_V0_1

## NEXT TASK RULES
The next task may create the first short in-place motion test from the approved motion gate.
