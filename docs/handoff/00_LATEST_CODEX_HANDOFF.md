...
LATEST_COMPLETED_TASK = PREPARE_LIMITED_INTERNAL_FOLLOW_UP_TASK_LIST_FROM_APPROVED_PLANNING_GATE_V0_1
...
## NEXT SAFE TASK
NEXT_SAFE_TASK = REVIEW_LIMITED_INTERNAL_FOLLOW_UP_TASK_LIST_FROM_APPROVED_PLANNING_GATE_V0_1

## NEXT TASK RULES
The next task must review the limited internal follow-up task list before reopening any character asset production work.
