...
> Đường cong: DORMANT ~10–15% peak (gần tắt, ngủ đọc đúng là ngủ) · MID ~35–45% · AWAKENED = peak HIỆN TẠI (không tăng) · ignition nhanh ~60–75% clip · loop mượt (decay về dormant cuối). Tương phản đến từ dormant sâu, **KHÔNG tăng bloom/peak** (= BLOOM_CHEAT).
