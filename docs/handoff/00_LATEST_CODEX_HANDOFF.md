...
LATEST_COMPLETED_TASK = PREPARE_LIMITED_INTERNAL_ASSET_DECISION_GATE_FROM_DIAGNOSTIC_STILL_REVIEW_V0_1
...
## NEXT SAFE TASK
NEXT_SAFE_TASK = REVIEW_LIMITED_INTERNAL_ASSET_DECISION_GATE_FROM_DIAGNOSTIC_STILL_REVIEW_V0_1

## NEXT TASK RULES
The next task may review the limited internal asset decision gate from the diagnostic still review.
