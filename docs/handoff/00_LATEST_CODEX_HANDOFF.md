...
LATEST_COMPLETED_TASK = REVIEW_DEFORMATION_SMOKE_TEST_FAILURE_FROM_FIRST_WEIGHT_BIND_PASS_V0_1
...
## NEXT SAFE TASK
NEXT_SAFE_TASK = CREATE_TARGETED_LEFT_HAND_BIND_REPAIR_FROM_SMOKE_TEST_FAILURE_V0_1

## NEXT TASK RULES
The next task may create a targeted left hand bind repair in the approved derivative only.
