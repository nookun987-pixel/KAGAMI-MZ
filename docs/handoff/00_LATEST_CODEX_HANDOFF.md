...
CONTROLLED_RUNTIME_EXCEPTION:
  ...
  CURRENT_CONTROLLER = MIKAGE_PUBLIC_RENDER_CANDIDATE_FIX_REVIEW_V0_1
  ...
  candidate for a future public-render-ready gate. Do not claim public render
  ready, asset lock, or final public completion here.
  ...
  Next safe task: OPEN_PUBLIC_RENDER_READY_GATE.
