...
LATEST_COMPLETED_TASK = CREATE_INTERNAL_DIAGNOSTIC_STILL_RENDER_SET_FROM_APPROVED_GATE_V0_1
...
## NEXT SAFE TASK
NEXT_SAFE_TASK = REVIEW_INTERNAL_DIAGNOSTIC_STILL_RENDER_SET_FROM_APPROVED_GATE_V0_1

## NEXT TASK RULES
The next task may review the internal diagnostic still render set created from the approved gate.
