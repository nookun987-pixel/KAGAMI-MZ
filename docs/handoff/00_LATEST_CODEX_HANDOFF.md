...
CURRENT_NEXT_TASK:
  OWNER_CHOOSES_ASSET_LOCK_GATE_WEBSITE_PAGE_UPDATE_GATE_OR_HOLD
...
CONTROLLED_RUNTIME_EXCEPTION:
  ...
  CURRENT_CONTROLLER = MIKAGE_PUBLIC_RENDER_READY_GATE_V0_1
  ...
  approved `PUBLIC_RENDER_READY = YES`. Do not claim asset lock, website/page
  update, push, deployment, or final public completion here.
  ...
  Next safe task: OWNER_CHOOSES_ASSET_LOCK_GATE_WEBSITE_PAGE_UPDATE_GATE_OR_HOLD.
