...
## NEXT SAFE TASK
NEXT_SAFE_TASK = REVIEW_CHARACTER_ASSET_PRODUCTION_PLAN_FROM_LIMITED_FINAL_RIG_V0_1

## NEXT TASK RULES
The next task may review the prepared character asset production plan from the limited final rig declaration.

The next task must not create cinematic shots, public output, final animation quality claims, cinematic readiness claims, final trailer claims, or character completion claims.
