...
LATEST_COMPLETED_TASK = REVIEW_LIMITED_INTERNAL_FOLLOW_UP_PLANNING_GATE_FROM_LIMITED_DOWNSTREAM_DECISION_WORK_V0_1
...
## NEXT SAFE TASK
NEXT_SAFE_TASK = PREPARE_LIMITED_INTERNAL_FOLLOW_UP_TASK_LIST_FROM_APPROVED_PLANNING_GATE_V0_1

## NEXT TASK RULES
The next task must prepare a limited internal follow-up task list from the approved planning gate before reopening any character asset production work.
