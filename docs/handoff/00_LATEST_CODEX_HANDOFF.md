...
LATEST_COMPLETED_TASK = REVIEW_DEFORMATION_SMOKE_TEST_RERUN_AFTER_TARGETED_LEFT_HAND_BIND_REPAIR_V0_1
...
## NEXT SAFE TASK
NEXT_SAFE_TASK = PREPARE_MOTION_GATE_FROM_DEFORMATION_SMOKE_TEST_RERUN_V0_1

## NEXT TASK RULES
The next task may prepare a motion gate from the approved deformation smoke test rerun.
