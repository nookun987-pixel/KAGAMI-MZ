...
LATEST_COMPLETED_TASK = REVIEW_LIMITED_INTERNAL_ASSET_DECISION_GATE_FROM_DIAGNOSTIC_STILL_REVIEW_V0_1
...
## NEXT SAFE TASK
NEXT_SAFE_TASK = PREPARE_LIMITED_DOWNSTREAM_INTERNAL_ASSET_DECISION_WORK_FROM_LIMITED_GATE_V0_1

## NEXT TASK RULES
The next task may prepare limited downstream internal asset decision work from the reviewed limited gate.
