...
LATEST_COMPLETED_TASK = REVIEW_CINEMATIC_GATE_FROM_FIRST_MOTION_TEST_V0_1
...
## NEXT SAFE TASK
NEXT_SAFE_TASK = CREATE_FIRST_DIAGNOSTIC_CINEMATIC_PROOF_SHOT_FROM_APPROVED_GATE_V0_1

## NEXT TASK RULES
The next task may create the first diagnostic cinematic proof shot from the approved gate.
