...
## NEXT SAFE TASK
NEXT_SAFE_TASK = PREPARE_FINAL_RIG_READINESS_GATE_FROM_DIAGNOSTIC_CINEMATIC_PROOF_V0_1

## NEXT TASK RULES
The next task may prepare a final rig readiness gate from the diagnostic cinematic proof milestone.
