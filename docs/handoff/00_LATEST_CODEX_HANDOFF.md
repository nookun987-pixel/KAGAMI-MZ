...
CURRENT_NEXT_TASK:
  OWNER_CHOOSES_WEBSITE_PUBLIC_PAGE_UPDATE_GATE_ROSTER_PAGE_PUBLISHING_GATE_PUSH_GATE_OR_HOLD
...
CONTROLLED_RUNTIME_EXCEPTION:
  ...
  CURRENT_CONTROLLER = MIKAGE_OWNER_APPROVED_PUBLIC_RENDER_ASSET_LOCK_STATUS_UPDATE_V0_1
  ...
  Next safe task: Owner chooses website/public page update gate, roster/page publishing gate, push gate, or hold.
