...
## NEXT SAFE TASK
NEXT_SAFE_TASK = PREPARE_INTERNAL_STATIC_ASSET_PLANNING_PACKAGE_FROM_LIMITED_FINAL_RIG_V0_1

## NEXT TASK RULES
The next task may prepare an internal static asset planning package from the limited final rig declaration.
